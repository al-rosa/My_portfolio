...
class ITextStyle {
  ...
  static const TextStyle minRegularText = TextStyle(
    fontSize: 14,
    color: IColor.textColor,
  );
  ...
  static const TextStyle minBoldText = TextStyle(
      fontSize: 24, color: IColor.textColor, fontWeight: FontWeight.bold);
  static const TextStyle minMidText =
      TextStyle(fontSize: 19, color: IColor.textColor);
...
class IColor {
  ...
  static const Color background = Color(0xffF2EFEA);
